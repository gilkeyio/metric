...
class TestParser(unittest.TestCase):
    ...
    def _assert_parse_error(self, code: str, expected_error: str) -> None:
    ...
    def test_parse_statement_separators_only(self)  -> None:
    ...
    def test_parse_error_empty_tokens(self)  -> None:
        tokens: list[TokenType] =[]
        ast = parse(tokens)
        self.assertEqual(ast, [])
    
    def test_parse_error_invalid_statement(self)  -> None:
    ...
    def test_parse_error_let_missing_equals(self)  -> None:
    ...
    def test_parse_from_string_simple(self)  -> None:
    ...
    def test_parse_arithmetic_precedence_integration(self)  -> None:
    ...
    def test_parse_error_if_missing_condition(self)  -> None:
        tokens: list[TokenType] =[Token.IF, Token.STATEMENT_SEPARATOR]
        with self.assertRaises(ParseError) as cm:
            parse(tokens)
        self.assertEqual(str(cm.exception), "Expected integer, float, identifier, boolean, or opening parenthesis")
    
    def test_parse_error_if_missing_body(self)  -> None:
    ...
    def test_parse_error_while_missing_body(self)  -> None:
    ...
    def test_parse_error_set_missing_equals(self)  -> None:
    ...
    def test_parse_mixed_statements_and_comments(self)  -> None:
        code = code_block("""
            # Program start
    ...
    def test_parse_comment_only_program(self)  -> None:
        code = code_block("""
            # First comment
            # Second comment
            # Third comment
    ...
    def test_parse_complex_program_with_comments(self)  -> None:
        code = code_block("""
            # Calculate factorial
    ...
    def test_parse_simple_function_declaration(self)  -> None:
    ...
    def test_parse_complex_list_operations(self)  -> None:
    ...
    def test_parse_error_list_missing_of(self)  -> None:
    ...
    def test_parse_error_list_missing_closing_bracket(self)  -> None:
    ...
    def test_parse_error_list_access_missing_closing_bracket(self)  -> None:
    ...
    def test_parse_error_repeat_missing_parenthesis(self)  -> None:
    ...
    def test_parse_error_len_missing_parenthesis(self)  -> None:
